...
public class ChangePassword extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String oldCheck="";
        String New = jTextField2.getText();
        String Confirm = jTextField3.getText();
        try
        {
            Class.forName("com.mysql.jdbc.Driver");
            Connection connection= DriverManager.getConnection("jdbc:mysql://localhost:3306/scd_project","root","");
            Statement st = connection.createStatement();
            String Query ="SELECT * FROM registerforlogin";
            ResultSet rset = st.executeQuery(Query);
            while(rset.next())
            {
                oldCheck = rset.getString("Password");
                
            }

           
            
            if(oldCheck.equals(old))
            {
                pubdate();
    ...
    void pubdate()
    {
        ...
        try{
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/scd_project", "root","");
                String sql = "UPDATE registerforlogin SET Password = '"+New+"',RePassword = '"+Confirm+"' Where Password = '"+old+"'";
